    ...
    return (
      <div className="text-center py-10">
        ...
        <Button 
          ...
          className="bg-[hsl(210,80%,85%)] text-[hsl(210,80%,30%)] hover:bg-[hsl(210,80%,75%)] dark:bg-[hsl(210,80%,30%)] dark:text-white dark:hover:bg-[hsl(210,80%,40%)] transition-colors duration-300"
        >
          Refresh
        </Button>
      </div>
