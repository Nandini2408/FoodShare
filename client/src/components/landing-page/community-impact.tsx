    ...
    <section className="py-16 bg-[#4CAF50]/5 dark:bg-[#0f3460] transition-colors duration-300">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-soft shadow-soft dark:shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-2 hover:bg-white/90 dark:hover:bg-gray-800/90 group">
            <div className="text-3xl md:text-4xl font-montserrat font-bold text-[#4CAF50] dark:text-[#7bed9f] mb-2 transition-all duration-300 group-hover:scale-110 group-hover:translate-y-[-2px]">
              12,580
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-soft shadow-soft dark:shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-2 hover:bg-white/90 dark:hover:bg-gray-800/90 group">
            <div className="text-3xl md:text-4xl font-montserrat font-bold text-[#FF9800] dark:text-[#fbbf24] mb-2 transition-all duration-300 group-hover:scale-110 group-hover:translate-y-[-2px]">
              2,450
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-soft shadow-soft dark:shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-2 hover:bg-white/90 dark:hover:bg-gray-800/90 group">
            <div className="text-3xl md:text-4xl font-montserrat font-bold text-[#42A5F5] dark:text-[#60a5fa] mb-2 transition-all duration-300 group-hover:scale-110 group-hover:translate-y-[-2px]">
              4.2
            </div>
