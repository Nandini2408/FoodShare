    ...
    <section id="how-it-works" className="py-16 bg-white dark:bg-gray-900 transition-colors duration-300">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Step 1 */}
          <div className="bg-[#F5F5F5] dark:bg-gray-800 p-6 rounded-soft shadow-soft dark:shadow-md text-center transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group">
            <div className="w-16 h-16 bg-[#4CAF50]/10 dark:bg-[#4CAF50]/20 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300 group-hover:scale-110">
              <Sprout className="h-8 w-8 text-[#4CAF50] dark:text-[#7bed9f] transition-transform duration-300 group-hover:scale-125 group-hover:rotate-12" />
            </div>
          ...
          {/* Step 2 */}
          <div className="bg-[#F5F5F5] dark:bg-gray-800 p-6 rounded-soft shadow-soft dark:shadow-md text-center transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group">
            <div className="w-16 h-16 bg-[#42A5F5]/10 dark:bg-[#42A5F5]/20 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300 group-hover:scale-110">
              <SearchCheck className="h-8 w-8 text-[#42A5F5] dark:text-[#60a5fa] transition-transform duration-300 group-hover:scale-125 group-hover:rotate-12" />
            </div>
          ...
          {/* Step 3 */}
          <div className="bg-[#F5F5F5] dark:bg-gray-800 p-6 rounded-soft shadow-soft dark:shadow-md text-center transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group">
            <div className="w-16 h-16 bg-[#FF9800]/10 dark:bg-[#FF9800]/20 rounded-full flex items-center justify-center mx-auto mb-4 transition-all duration-300 group-hover:scale-110">
              <Users className="h-8 w-8 text-[#FF9800] dark:text-[#fbbf24] transition-transform duration-300 group-hover:scale-125 group-hover:rotate-12" />
            </div>
