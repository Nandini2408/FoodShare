            ...
            <div key={item.id} className="bg-white dark:bg-gray-800 rounded-soft shadow-soft dark:shadow-md overflow-hidden transition-all duration-300 hover:shadow-2xl hover:translate-y-[-5px] group" style={{ pointerEvents: 'none' }}>
              ...
              <div className="p-4">
                ...
                <div className="mt-4 flex justify-between items-center">
                  ...
                  <Button 
                    className={`
                      px-3 py-1 text-sm rounded-soft transition-all duration-300
                      ${item.type === 'donation' 
                        ? 'bg-[hsl(210,80%,85%)] hover:bg-[hsl(210,80%,75%)] dark:bg-[hsl(210,80%,30%)] dark:hover:bg-[hsl(210,80%,40%)] text-[hsl(210,80%,30%)] dark:text-white hover:shadow-md hover:scale-105 hover:-translate-y-1' 
                        : 'bg-[#42A5F5] hover:bg-[#1976D2] dark:bg-[#1976D2] dark:hover:bg-[#42A5F5] hover:shadow-md hover:scale-105 hover:-translate-y-1'}
                    `}
